...
const faqs = [
    {
        ...
        answer: 'Search engine optimization (SEO) is a collection of techniques and best practices aimed at improving a site\'s visibility in the organic search results to attract qualified traffic. In other words "Everything is done to ensure getting found on the Internet and to make sure that the ensuing traffic converts."',
    },
    {
        id: 2,
        question: "Which SEO technique is more fundamental?",
        answer: "Both on-page and off-page optimization are necessary to achieve effective, long-term SEO success in most industries.",
    },
    {
        id: 3,
        question: "What is organic traffic?",
        answer: "Organic (natural) search traffic refers to the unpaid traffic that naturally finds its way to a site through search engines. Most organic traffic originates from a search entered into a major search engine such as Google, Bing, Yahoo or even YouTube or Google image search.",
    },
    {
        id: 4,
        question: "What is the difference between on-page & off-page SEO?",
        answer: "On-page optimization involves developing your site's content for relevance to popular keywords and ensuring that its code and content are correctly structured such that search engine spiders can index them. Off-page optimization refers to the quality and quantity of links pointing to a page, which is used by search engines to help determine authority and relevance.",
    },
    {
        id: 5,
        question: "What is blacklisting?",
        answer: "A site can be blacklisted if unethical search engine positioning tactics have been used or if the search engine algorithm determines that it believes they have been. It can be very difficult to recover from a blacklisting; often it is easier to simply use another domain with a new site and move forward from there after cleaning out whatever spam tactic got you banned.",
    },
    {
        id: 6,
        question: "How long does it take for the results to show up?",
        answer: "There is no specific timeframe as every website is different and every website targets different keywords. Depending on the competition, the website and a few other factors it can take from a few weeks to a few months for the results to show up.",
    },
];
                ...
                <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
                    <div>
                        ...
                        <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                            ...
                            attract qualified traffic. There are customers
                            searching for your services but your website is not
                            one of the top results of Google. To avoid losing
                            business and money, you should go for one of our SEO
                            solutions.
                        </p>
                    </div>
