                    ...
                    <div className="grid grid-cols-1 items-center justify-between gap-x-5 md:grid-cols-2">
                        <div>
                            ...
                            <p className="mt-3 mb-20 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                                Attract more customers by advertising on the
                                world's most used search engine. Start an
                                effective campaign on Google with help of our
                                experts right away.
                            </p>
                        </div>
                ...
                <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
                    <div>
                        ...
                        <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                            Advertising on Google is the fastest way to get more
                            leads and traffic to your website. An effective and
                            optimized campaign can get you the best value for
                            money.
                        </p>
                    </div>
                    <div className="">
                ...
                <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
                    ...
                    <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                        <div className="relative">
                            ...
                            <p className="mt-3 text-lg text-gray-500">
                                Advertising on Google is just a 3-step process.
                                You determine a daily/weekly/monthly budget for
                                your campaign and the rest is handled by our
                                expert team. We will find suitable keywords and
