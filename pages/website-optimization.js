            ...
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">
                  Super-charge your website with our
                </span>
          ...
          <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <div className="relative">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
                ...
                less than two seconds until they consider leaving – 40 per cent
                of users will leave the site in the third second of loading,
                before a performance monitoring tool even detects their presence
                on the site. The total conversion peak load time is just 2
                seconds-faster than millions of websites.
              </p>
            </div>
            ...
            <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div className="relative">
                ...
                <p className="mt-3 text-lg text-gray-500">
                  ...
                  counterparts. By significantly speeding up the loading speed
                  of your websites we will help you boost your search ranking.
                  We'll send you a report before and after you've used our
                  service.
                </p>
              </div>
            ...
            <div className="z-10 relative mt-12 sm:mt-16 lg:mt-24">
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div className="lg:col-start-2">
                  ...
                  <p className="mt-3 text-lg text-gray-500">
                    The main reason why optimizing your images is so important
                    is that 90% of most webpages rely heavily on graphics, so
                    there is a great deal of digital images. Having left these
                    images uncompressed and in the wrong format can
                    significantly slow loading speed of your website. Enhancing
                    web images can reduce your total loading time by 80 percent.
                    Full optimization of images can be quite a process to
                    perfect, as there are such a wide range of image data which
            ...
            <div className="relative mt-12 lg:mt-24 lg:grid lg:justify-center lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div className="relative">
                ...
                <p className="mt-3 text-lg text-gray-500">
                  ...
                  instantly. We'll optimize your WordPress to give your
                  WordPress website an SEO boost in a fast and reasonable
                  manner! Our WordPress optimization process includes cache
                  configuration, image optimization and CSS/JS minification.
                </p>
              </div>
