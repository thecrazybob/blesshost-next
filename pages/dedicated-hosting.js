            ...
            <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
              <div className="sm:flex sm:flex-col sm:align-center">
                ...
                <p className="mt-5 text-xl text-gray-500 sm:text-center">
                  Get the plan that suits your business needs and upgrade as
                  your business grows.
                </p>
          ...
          <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <div className="relative">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
                ...
                availability on demand. Just-in-time deployment will enable you
                to control heavy workloads and most demanding applications.
              </p>
            </div>
                ...
                <blockquote>
                  <div>
                    ...
                    <p className="mt-6 text-2xl font-medium text-white">
                      For a small/medium size business the cost is attractive
                      and the customer support is awesome. When it comes to
                      support, the BlessHost team is extremely helpful. I am a
                      client of several years and my website haven't faced any
                      downtime until now.
                    </p>
                  </div>
