            ...
            <div className="max-w-7xl mx-auto py-16 lg:py-24 lg:grid lg:grid-cols-2 lg:grid-flow-col lg:gap-x-8">
                <div>
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                        The purpose-built, highly specified data centre space
                        with a full range of colocation, interconnection,
                        support and monitoring services provides access to the
                        rapidly expanding Middle Eastern digital hub allowing
                        you to connect directly and quickly to the cloud,
                        content, mobility and financial services companies. The
                        facility is connected to UAE-IX, the UAE Internet
                        Exchange, provides vital peering opportunities to other
                        UAE-IX members.
                    </p>
                </div>
