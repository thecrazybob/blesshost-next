      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-4">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Websites</h3>
                <ul className="mt-4 space-y-4">
          ...
          <div className="mt-12 xl:mt-0">
            ...
            <div class="mt-6 flex text-white space-x-2">
                <svg viewBox="0 0 576 512" class="h-8 fill-current">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <div className="order-2 text-gray-400 mt-8 md:mt-0">Made with love in Abu Dhabi, UAE 🇦🇪</div>
