            ...
            <div className="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
                <div className="md:ml-auto md:w-1/2 md:pl-10">
                    ...
                    <p className="mt-3 text-lg text-gray-300">
                        From a new website to helping with you with your
                        existing website, our team of experts is available to
                        help you choose the best solution for your needs. If you
                        are still undecided, do not hesitate and get in touch
                        with us right away.
                    </p>
